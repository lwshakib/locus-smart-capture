...
function App() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (el.closest('#crxjs-app') || el.tagName.toLowerCase() === 'html' || el.tagName.toLowerCase() === 'body') {
        setHoveredBounds(null)
        hoveredElementRef.current = null
        return
      }
  ...
  return (
    <div 
      className={`locus-capture-root ${mode === 'manual' ? 'cursor-crosshair' : 'cursor-default'}`}
        ...
        <>
          ...
          >
            ...
            <span className="locus-dim">
              {Math.round(hoveredBounds.width)} × {Math.round(hoveredBounds.height)}
            </span>
          </div>
          <div className="locus-guide-tooltip">
